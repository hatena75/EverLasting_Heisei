...
namespace STG.Item
{
    class TriShotItem : Item
    {

        //private asd.SoundSource itemGet;


        public TriShotItem(asd.Vector2DF pos) : base(pos)
        {
            Texture = asd.Engine.Graphics.CreateTexture2D("Resources/Item7.png");
            /*
        ...
        public override void OnCollide(CollidableObject obj)
        {
            ...
            Singleton.singleton.itemhaving = 4;
        ...
        private void CollideWith(CollidableObject obj)
        {
            ...
            if (obj is Bullet)
            {
                ...
                if (IsCollide(bullet))
                {
                    OnCollide(bullet);
                    bullet.OnCollide(this);
                    asd.Engine.AddObject2D(new ItemGetEffect_TriShot(new asd.Vector2DF(320, 240)));
