...
namespace STG.Item
{
    class BombItem : Item
    {
        ...
        public BombItem(asd.Vector2DF pos) : base(pos)
        {
            Texture = asd.Engine.Graphics.CreateTexture2D("Resources/Item1.png");
        ...
        protected void CollideWith(CollidableObject obj)
        {
            ...
            if (obj is Bullet)
            {
                ...
                if (IsCollide(bullet))
                {
                    OnCollide(bullet);
                    bullet.OnCollide(this);
                    asd.Engine.AddObject2D(new ItemGetEffect_Bomb(new asd.Vector2DF(320, 240)));
